...
@onready var title: RichTextLabel = $Panel/RichTextLabel
...
func initialize(scene_name: String, scene_path: String) -> void:

	title.text = scene_name.to_snake_case().capitalize()
	path = scene_path
